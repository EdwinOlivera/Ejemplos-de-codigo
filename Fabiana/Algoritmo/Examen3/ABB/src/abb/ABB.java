...
public class ABB {
    ...
    public static void Menu() {
        ...
        do {
            ...
            System.out.println("8. Numero de nodos con dos hijos");
            System.out.println("9. Comprobar nivel");
            ...
            switch (opcion) {
                ...
                case "8":
                    System.out.println("La Cantidad de nodos que tiene dos hijos son " + ArbolBinBusq.contarNodosHijos());
                    pausa();
                    break;
                case "9":
                    System.out.println("Ingrese el numero del nivel a comprobar");
                    tmpNumero = teclado.nextInt();
                    ArbolBinBusq.ComprobarNivel(tmpNumero);
                    pausa();
